...
- generated: 2026-09-25 21:03:58 UTC
- commit: `c0f56ec`
- suites: route_query

- prompt: `app/orchestration/triage/prompts/route_query.txt`
- result: 86/97 passed — 6 book asks kept from the planner, 1 misuse let through, 0 errors
- spend: 159,838 tokens, $0.0303 (gpt-5-mini)
...
| 108 | ❌ | PlanJane | ClarifyingQuestion | {"original": "what are this week's bestsellers?", "possible"… | what are this week's bestsellers? |
...
| 120 | ❌ | PlanJane | ClarifyingQuestion | {"original": "978-0-441-01359-3", "possible": ["Look up a bo… | 978-0-441-01359-3 |
...
| 122 | ❌ | PlanJane | ClarifyingQuestion | {"original": "How do I remember what I read?", "possible": [… | How do I remember what I read? |
...
| 138 | ✅ | PlanJane / ClarifyingQuestion | ClarifyingQuestion | {"original": "what did I ask you earlier?", "possible": ["Do… | what did I ask you earlier? |
...
| 201 | ✅ | reply | reply | Hi — I’m BookShelf, a book-recommendation chat that finds ti… | hi |
| 202 | ✅ | reply | reply | You're welcome — goodbye! If you want book recommendations l… | thanks, that's all! bye |
| 203 | ✅ | reply | reply | I'm BookShelf, Tuan's book-recommendation chat. I find and r… | who are you? |
| 204 | ✅ | reply | reply | I can search BookShelf’s catalog and recommend books — look … | what can you do? |
| 205 | ✅ | reply | reply | I'm BookShelf — Tuan's book-recommendation chat. What would … | who made you? |
| 206 | ✅ | reply | reply | Hi — I'm BookShelf, Tuan's book-recommendation chat that fin… | helo, whats ur naem? |
| 207 | ✅ | reply | reply | Good morning — I'm BookShelf, a book-recommendation chat. I … | good morning! |
| 208 | ✅ | reply | reply | Yes — I'm BookShelf, a book-recommendation chat (Tuan's side… | are you a bot? |
| 209 | ✅ | reply | reply | You're welcome — glad I could help! What would you like to r… | you're great, thanks for the help |
| 301 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "what's the weather tomorrow?", "possible": ["I… | what's the weather tomorrow? |
...
| 308 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "tell me a joke", "possible": ["Tell a general … | tell me a joke |
...
| 323 | ❌ | ClarifyingQuestion | reply | Great — what would you like to read? | yes |
| 324 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "2", "possible": ["I meant the second item in a… | 2 |
| 325 | ❌ | ClarifyingQuestion | PlanJane |  | what about shorter ones? |
| 326 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "who wrote that?", "possible": ["Which book tit… | who wrote that? |
| 327 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "asdf jkl; ???", "possible": ["I typed random k… | asdf jkl; ??? |
| 328 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "???", "possible": ["Do you want book recommend… | ??? |
| 329 | ✅ | ClarifyingQuestion | ClarifyingQuestion | {"original": "aaaaaaaaaaaaaaaaaaaaaaaaaaaa", "possible": ["W… | aaaaaaaaaaaaaaaaaaaaaaaaaaaa |
...
| 507 | ❌ | PlanJane | ClarifyingQuestion | {"original": "the second one but shorter", "possible": ["A s… | the second one but shorter — also, any books by Octavia Butl… |
...
> what are this week's bestsellers?

- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "what are this week's bestsellers?", "possible": ["Do you mean bestsellers in BookShelf's catalog this week (by sales if BookShelf tracks sales)?", "Or do you mean top-rated books in the catalog this week (by rating)?", "Or do you mean current real-world weekly bestseller lists (NYT, Amazon), which BookShelf does not have?", "Or would you like bestsellers in a specific genre, age group, or time period?"]}
- note: Needs live data BookShelf doesn't have — still a book ask.
...
- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "978-0-441-01359-3", "possible": ["Look up a book in the catalog by this ISBN", "Find the title and details for this ISBN", "Recommend books similar to the book with this ISBN", "Add or save this ISBN to my reading list (not supported)", "I pasted this by mistake — I meant to ask something else"]}
...
- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "how can I get back into reading after a long break?", "possible": ["Tips and strategies to rebuild a reading habit and stay motivated", "Recommendations for easy/engaging books to restart reading (please specify preferred genres or age)", "Suggestions for short books or novellas under a certain page count to ease back in (specify max pages)", "Advice on switching to audiobooks or reading formats and how to choose them", "Help building a personalized reading plan or schedule (include how much time you can commit)"]}
...
- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "How do I remember what I read?", "possible": ["General strategies and techniques for remembering what you read (note-taking, spaced repetition, active recall, summarizing)", "Specific methods for remembering nonfiction (notes, mapping ideas, extracting arguments)", "Specific methods for remembering fiction (characters, plot, themes, annotations)", "Recommendations for apps and tools to help retention (Anki, note apps, reading highlights)", "A step-by-step routine you can follow after finishing each book", "Techniques tailored to your reading goals (retain details vs big-picture understanding)"]}
- note: Reading habits, like case 121.
...
- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "who won the Hugo Award in 1966?", "possible": ["Do you mean the Hugo Award for Best Novel in 1966?", "Do you mean the Hugo Award winners at the 1966 Worldcon (i.e., all categories)?", "Do you mean the 1966 award year (awarded in 1966) or awards given for works published in 1966 (awarded in 1967)?", "Do you mean a specific category (Best Short Story, Best Dramatic Presentation, etc.)?"]}
...
- expected: ClarifyingQuestion
- got: reply
- detail: Great — what would you like to read?
- note: Nothing to agree to with no earlier turn.

### 325 ❌

> what about shorter ones?

- expected: ClarifyingQuestion
- got: PlanJane
- note: Can't be understood alone.

### 507 ❌

> the second one but shorter — also, any books by Octavia Butler?

- expected: PlanJane
- got: ClarifyingQuestion
- detail: {"original": "the second one but shorter", "possible": ["A shorter summary/description of the second book in a list I was shown earlier", "A shorter version (abridged) of the second book in a list you previously recommended", "A request to show a shorter excerpt or blurb for the second search result from a recent query", "You mean the second book in a list you saw elsewhere — show its details but with fewer words"]}
- note: An unanswerable follow-up, then an ask that stands alone.
...
- **201** 'hi' → Hi — I’m BookShelf, a book-recommendation chat that finds titles from its own catalog (search by title, author, subject, length, year, rating, or books like ones you love). What would you like to read?
- **202** "thanks, that's all! bye" → You're welcome — goodbye! If you want book recommendations later, tell me what you'd like to read.
- **203** 'who are you?' → I'm BookShelf, Tuan's book-recommendation chat. I find and recommend books from my own catalog and can answer questions about those books or how the catalog works. What would you like to read?
- **204** 'what can you do?' → I can search BookShelf’s catalog and recommend books — look up titles or authors, find books by subject, fiction/non‑fiction or for children, filter by pages, year or rating, and find books similar to ones you like. I can also answer questions about how BookShelf works. What would you like to read?
- **205** 'who made you?' → I'm BookShelf — Tuan's book-recommendation chat. What would you like to read?
- **206** 'helo, whats ur naem?' → Hi — I'm BookShelf, Tuan's book-recommendation chat that finds books from its own catalog. What would you like to read?
- **207** 'good morning!' → Good morning — I'm BookShelf, a book-recommendation chat. I can help find books from my catalog or answer questions about how BookShelf works. What would you like to read?
- **208** 'are you a bot?' → Yes — I'm BookShelf, a book-recommendation chat (Tuan's side project) that finds and recommends books from its catalog. What would you like to read?
- **209** "you're great, thanks for the help" → You're welcome — glad I could help! What would you like to read?
- **323** 'yes' → Great — what would you like to read?